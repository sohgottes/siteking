  ...
  window.siteRoutes = [{
    "name": "Página Inicial",
    "path": "pagina-inicial",
    "title": "Página Inicial - KingLion Móveis Planejados"
  }, {
    "name": "Sobre Nós",
    "path": "sobre-nos",
    "title": "Sobre Nós - KingLion Móveis Planejados"
  }, {
    "name": "Portfólio",
    "path": "portfolio",
    "title": "Portfólio - KingLion Móveis Planejados"
  }, {
    "name": "Galeria",
    "path": "galeria",
    "title": "Galeria - KingLion Móveis Planejados"
  }];
  window.attachments = [];
  window.turi = {
    "botUrl": null,
  ...
  try {
    ...
    Navigation = /*#__PURE__*/React.createElement(ErrorBoundary, {
      ...
      "navItems": ["text=Página Inicial&link=pagina-inicial", "text=Sobre Nós&link=sobre-nos", "text=Portfólio&link=portfolio", "text=Galeria&link=galeria"],
      "showButton": false,
      "primaryButton": {
        "icon": "fa-solid fa-arrow-right",
